...
<div id="quickSelectModal" class="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 hidden opacity-0 transition-all duration-300 pointer-events-none" aria-hidden="true">
  <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden border border-stone-200 transform scale-95 transition-all duration-300 flex flex-col max-h-[90vh]" data-modal-container>
    ...
    <div class="p-4 bg-stone-50 border-t border-stone-100 grid grid-cols-2 gap-3">
      <button type="button" id="qmAddToCartBtn" class="w-full border-2 border-brand-500 bg-transparent text-brand-500 hover:bg-brand-500 hover:text-white font-extrabold py-3 px-4 rounded-xl shadow transition-all flex items-center justify-center gap-1.5 text-xs sm:text-sm uppercase tracking-wide cursor-pointer disabled:bg-stone-100 disabled:text-stone-400 disabled:border-stone-200 disabled:cursor-not-allowed disabled:pointer-events-none">
      ...
      <button type="button" id="qmBuyNowBtn" class="w-full bg-[#0B2523] hover:bg-black text-white font-extrabold py-3 px-4 rounded-xl shadow transition-all flex items-center justify-center text-xs sm:text-sm uppercase tracking-wide cursor-pointer disabled:bg-stone-200 disabled:text-stone-400 disabled:cursor-not-allowed disabled:pointer-events-none">
        <span>BUY NOW</span>
      </button>
    </div>
  </div>
