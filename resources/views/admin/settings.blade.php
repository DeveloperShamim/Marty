...
<div class="settings-page w-full max-w-3xl mx-auto space-y-5 sm:space-y-6">
  ...
  <form method="POST" action="{{ route('admin.settings.update-section', 'homepage') }}" class="settings-section-form" data-section="homepage">
    ...
    <div class="card p-4 sm:p-5 space-y-4">
      ...
      <div class="section-feedback hidden text-sm rounded-lg px-3 py-2"></div>
      <p class="text-sm text-gray-500">Promo bar, section titles, and hero fallback copy. Flash Sale products and countdown are managed under <a href="{{ route('admin.flash-sale.index') }}" class="text-brand-700 font-semibold hover:underline">Flash Sale</a>.</p>
      ...
      <div class="border-t border-gray-100 pt-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div><label class="lbl">Featured products title</label><input name="home_featured_title" class="inp" value="{{ $settings['home_featured_title'] ?? '' }}" placeholder="Featured Products" /></div>
          <div><label class="lbl">Reviews title</label><input name="home_reviews_title" class="inp" value="{{ $settings['home_reviews_title'] ?? '' }}" placeholder="Customer Reviews" /></div>
          ...
          <div><label class="lbl">Default CTA button text</label><input name="default_cta_text" class="inp" value="{{ $settings['default_cta_text'] ?? '' }}" placeholder="SHOP NOW" /></div>
        </div>
      </div>
