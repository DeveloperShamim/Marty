...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $data = [
            ['Raw Honey & Natural Sweeteners', 'raw-honey-sweeteners', '🍯', '100% pure Sundarban raw honey, mustard flower honey & date molasses.', 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=600&h=600&q=80'],
            ['Cold-Pressed Oils & Pure Ghee', 'cold-pressed-oils-ghee', '🛢️', 'Wood-milled mustard oil, virgin coconut oil & Bilona cow milk ghee.', 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=600&h=600&q=80'],
            ['Organic Grains & Superfoods', 'grains-superfoods', '🌾', 'Aromatic Kataribogh rice, organic chia seeds, oats & unpolished pulses.', 'https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=600&h=600&q=80'],
            ['Pure Spices & Pantry', 'pure-spices-pantry', '🌶️', 'High curcumin turmeric, unadulterated red chili, cumin & rock salt.', 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=600&h=600&q=80'],
            ['Nuts, Seeds & Premium Dates', 'nuts-seeds-dates', '🥜', 'Imported Madinah Ajwa dates, Medjool dates, almonds & roasted cashews.', 'https://images.unsplash.com/photo-1596560548464-f010549b84d7?auto=format&fit=crop&w=600&h=600&q=80'],
            ['Herbal Teas & Wellness', 'herbal-teas-wellness', '🍵', 'Organic cold-pressed black seed oil, Tulsi herbal tea & moringa powder.', 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=600&h=600&q=80'],
        ];
